# AGENTS.md — flags-2-env/flags-2-env-mcp-server.rs
...
- GitHub org: [`flags-2-env`](https://github.com/flags-2-env)
- Repository: [`flags-2-env/flags-2-env-mcp-server.rs`](https://github.com/flags-2-env/flags-2-env-mcp-server.rs)
- Local checkout: `~/codes/flags-2-env/flags-2-env-mcp-server.rs`
- Linear project: https://linear.app/denman/project/githubcomflags-2-env-05db5133a267
- GitHub org project: https://github.com/orgs/flags-2-env/projects/1
- Sibling test org: `github.com/flags-2-env-test` (external/e2e coverage and extra GHA minutes)
...
- Package / service name: `flags-2-env-mcp-server`
